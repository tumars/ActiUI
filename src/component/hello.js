...
const Hello = () => (
	<div className={style.hello}>
		...
		<section>
			<h2>ActiUI 的特点？ </h2>
			<ul>
				<li><span>1.</span><span>每个组件相互独立解耦，单个组件所需的全部js、css、jsx等在同一文件夹内，按需下载使用即可</span></li>
				<li><span>2.</span><span>样式使用 <code>css module + less</code> 书写</span></li>
				<li><span>3.</span><span>使用 webpack 的构建工作流，<code>react + webpack</code> 的构建环境配置请参考：<a href="https://github.com/tumars/boilerplate-webpack-react-es6-cssModule/settings/collaboration">boilerplate-webpack-react-es6-cssModule</a></span></li>
			</ul>
		</section>
		<section>
			<h2>如何使用？</h2>
